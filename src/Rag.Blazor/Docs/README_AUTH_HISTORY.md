...
3. Uzyskaj Google ID Token:
   - Użyj [Google OAuth 2.0 Playground](https://developers.google.com/oauthplayground/)
   - Lub zaimplementuj prosty frontend z Google Sign-In
4. W Swagger UI kliknij przycisk "Authorize"
5. Wpisz token (Swagger automatycznie doda przedrostek "Bearer")
6. Testuj endpointy
